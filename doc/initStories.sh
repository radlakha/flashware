...
# Script to initialize /stories/ folder and add overview template
# Run from the root of the repo

# Create stories folder
mkdir -p stories

# Create overview-template.md
cat << EOF > stories/overview-template.md
...
echo "Stories folder initialized with overview-template.md successfully!"